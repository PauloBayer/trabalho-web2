...
const historico1_ABERTA: IHistorico = { id: '1', statusAtual: 'ABERTA', dataHora: '2023-09-01T12:45:30Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };

// Solicitação 2 - ORCADA
const historico2_ABERTA: IHistorico = { id: '2a', statusAtual: 'ABERTA', dataHora: '2023-09-04T14:22:18Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };
const historico2_ORCADA: IHistorico = { id: '2b', statusAnterior: 'ABERTA', statusAtual: 'ORCADA', dataHora: '2023-09-04T14:22:18Z', valorOrcado: 200.0, funcionario: funcionario3 };

// Solicitação 3 - APROVADA
const historico3_ABERTA: IHistorico = { id: '3a', statusAtual: 'ABERTA', dataHora: '2023-09-04T14:22:18Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };
const historico3_ORCADA: IHistorico = { id: '3b', statusAnterior: 'ABERTA', statusAtual: 'ORCADA', dataHora: '2023-09-04T14:22:18Z', valorOrcado: 200.0, funcionario: funcionario3 };
const historico3_APROVADA: IHistorico = { id: '3c', statusAnterior: 'ORCADA', statusAtual: 'APROVADA', dataHora: '2023-09-04T14:22:18Z', valorOrcado: 200.0, funcionario: funcionario3 };

// Solicitação 4 - REJEITADA
const historico4_ABERTA: IHistorico = { id: '4a', statusAtual: 'ABERTA', dataHora: '2023-09-09T07:25:15Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };
const historico4_ORCADA: IHistorico = { id: '4b', statusAnterior: 'ABERTA', statusAtual: 'ORCADA', dataHora: '2023-09-09T07:25:15Z', valorOrcado: 200.0, funcionario: funcionario3 };
const historico4_REJEITADA: IHistorico = { id: '4c', statusAnterior: 'ORCADA', statusAtual: 'REJEITADA', dataHora: '2023-09-09T07:25:15Z', motivoRejeicao: 'motivoRejeicao lorem ipsum ergo sutum', funcionario: funcionario3 };

// Solicitação 5 - REDIRECIONADA
const historico5_ABERTA: IHistorico = { id: '5a', statusAtual: 'ABERTA', dataHora: '2023-09-08T13:40:30Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };
const historico5_ORCADA: IHistorico = { id: '5b', statusAnterior: 'ABERTA', statusAtual: 'ORCADA', dataHora: '2023-09-08T13:40:30Z', valorOrcado: 200.0, funcionario: funcionario2 };
const historico5_REDIRECIONADA: IHistorico = { id: '5c', statusAnterior: 'ORCADA', statusAtual: 'REDIRECIONADA', dataHora: '2023-09-08T13:40:30Z', funcionarioOrigem: funcionario2, funcionarioDestino: funcionario2 };

// Solicitação 6 - AGUARDANDO_PAGAMENTO
const historico6_ABERTA: IHistorico = { id: '6a', statusAtual: 'ABERTA', dataHora: '2023-09-05T16:50:12Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };
const historico6_ORCADA: IHistorico = { id: '6b', statusAnterior: 'ABERTA', statusAtual: 'ORCADA', dataHora: '2023-09-05T16:50:12Z', valorOrcado: 200.0, funcionario: funcionario3 };
const historico6_APROVADA: IHistorico = { id: '6c', statusAnterior: 'ORCADA', statusAtual: 'APROVADA', dataHora: '2023-09-05T16:50:12Z', valorOrcado: 200.0, funcionario: funcionario3 };
const historico6_AGUARDANDO_PAGAMENTO: IHistorico = { id: '6d', statusAnterior: 'APROVADA', statusAtual: 'AGUARDANDO_PAGAMENTO', dataHora: '2023-09-05T16:50:12Z', funcionario: funcionario3, descricaoManutencao: 'descricaoManutencao lorem ipsum ergo sutum', orientacoesManutencao: 'orientacoesManutencao lorem ipsum ergo sutum' };

// Solicitação 7 - PAGA
const historico7_ABERTA: IHistorico = { id: '7a', statusAtual: 'ABERTA', dataHora: '2023-09-20T08:35:50Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };
const historico7_ORCADA: IHistorico = { id: '7b', statusAnterior: 'ABERTA', statusAtual: 'ORCADA', dataHora: '2023-09-20T08:35:50Z', valorOrcado: 200.0, funcionario: funcionario3 };
const historico7_APROVADA: IHistorico = { id: '7c', statusAnterior: 'ORCADA', statusAtual: 'APROVADA', dataHora: '2023-09-20T08:35:50Z', valorOrcado: 200.0, funcionario: funcionario3 };
const historico7_AGUARDANDO_PAGAMENTO: IHistorico = { id: '7d', statusAnterior: 'APROVADA', statusAtual: 'AGUARDANDO_PAGAMENTO', dataHora: '2023-09-20T08:35:50Z', funcionario: funcionario3, descricaoManutencao: 'descricaoManutencao lorem ipsum ergo sutum', orientacoesManutencao: 'orientacoesManutencao lorem ipsum ergo sutum' };
const historico7_PAGA: IHistorico = { id: '7e', statusAnterior: 'AGUARDANDO_PAGAMENTO', statusAtual: 'PAGA', dataHora: '2023-09-20T08:35:50Z' };

// Solicitação 8 - FINALIZADA
const historico8_ABERTA: IHistorico = { id: '8a', statusAtual: 'ABERTA', dataHora: '2023-09-20T08:35:50Z', descricaoEquipamento: 'descricaoEquipamento lorem ipsum ergo sutum', descricaoDefeito: 'descricaoDefeito lorem ipsum ergo sutum' };
const historico8_ORCADA: IHistorico = { id: '8b', statusAnterior: 'ABERTA', statusAtual: 'ORCADA', dataHora: '2023-09-20T08:35:50Z', valorOrcado: 200.0, funcionario: funcionario2 };
const historico8_APROVADA: IHistorico = { id: '8c', statusAnterior: 'ORCADA', statusAtual: 'APROVADA', dataHora: '2023-09-20T08:35:50Z', valorOrcado: 200.0, funcionario: funcionario2 };
